...
#...
book1 = open_workbook("Data\\YelpNYC\\ReviewContent (Sortedby_Product_wise).xlsx")		# Change the path according to the file location
...
df.to_excel("Data\\YelpNYC\\Resulting Features\\Review_Centric_Behavioral_Features.xlsx", index = False)			# Change the path according to the file location
