...
#...
book = open_workbook("Data\\YelpNYC\\ReviewContent (Sortedby_Reviewer_wise).xlsx")			# Change the path according to the file location
...
df.to_excel("Data\\YelpNYC\\Resulting Features\\Reviewer_Centric_Textual_Features.xlsx", index = False)			# Change the path according to the file location
