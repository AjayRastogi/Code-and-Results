...
#...
book = open_workbook("Data\\YelpZip\\Metadata (Sortedby_Reviewer_wise).xlsx")		# Change the path according to the file location
...
#...
book1 = open_workbook("Data\\YelpZip\\Metadata (Sortedby_Product_wise).xlsx")		# Change the path according to the file location
...
df.to_excel("Data\\YelpZip\\Resulting Features\\Reviewer_Centric_Behavioral_Features.xlsx", index = False)		# Change the path according to the file location
