...
MODELS = ['SVM','LR','MLP']
workbook = xlsxwriter.Workbook("Data\\Results\\YelpZip\\Classifiers Performance on YelpZip.xlsx")		# Change the path according to the file location
worksheet = []
# Reviewer-Centric ......................................................................
for k in range(0,len(MODELS)):
	...
	for u in range(0,10):
		models.append(pickle.load(open('Data\\Results\\YelpZip\\Reviewer Behavioral\\'+str(MODELS[k])+'\\Model_'+str(u+1)+'.sav', 'rb')))		# Change the path according to the file location
	for u in range(0,10):
		models1.append(pickle.load(open('Data\\Results\\YelpZip\\Reviewer Textual\\'+str(MODELS[k])+'\\Model_'+str(u+1)+'.sav', 'rb')))			# Change the path according to the file location
...
for k in range(0,len(MODELS)):
	...
	for u in range(0,21):
		models.append(pickle.load(open('Data\\Results\\YelpZip\\Review Behavioral\\'+str(MODELS[k])+'\\Model_'+str(u+1)+'.sav', 'rb')))			# Change the path according to the file location
	for u in range(0,21):
		models1.append(pickle.load(open('Data\\Results\\YelpZip\\Review Textual\\'+str(MODELS[k])+'\\Model_'+str(u+1)+'.sav', 'rb')))			# Change the path according to the file location
