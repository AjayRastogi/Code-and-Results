...
if __name__ == "__main__":
	...
	X_new_spam = X_new.loc[X_new['Label'] == 1]				# Total spam
	X_new_notspam = X_new.loc[X_new['Label'] == 0]			# Total not-spam
	...
	for i in range(0,3):
		...
		filename = 'Data\\Results\\YelpNYC\\Review Behavioral\\'+cls[i]+'\\FPR_TPR_Threshold_Review_Behavioral.xlsx'		# File for Writing FPR and TPR values at different thresholds for ROC curve analysis
		filename1 = 'Data\\Results\\YelpNYC\\Review Behavioral\\'+cls[i]+'\\Pre_Recall_Threshold_Review_Behavioral.xlsx'	# File for Writing Precision and Recall values at different thresholds for Precision-recall curve analysis
		f = 'Data\\Results\\YelpNYC\\Review Behavioral\\'+cls[i]+'\\X_bal_sets.sav'
		...
		k = 1
		for mm in result:
			filename2 = 'Data\\Results\\YelpNYC\\Review Behavioral\\'+cls[i]+'\\Model_'+str(k)+'.sav'			# Change the path according to the file location
