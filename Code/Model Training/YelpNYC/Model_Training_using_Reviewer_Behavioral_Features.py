...
if __name__ == "__main__":
	...
	for i in range(0,3):
		...
		filename = 'Data\\Results\\YelpNYC\\Reviewer Behavioral\\'+cls[i]+'\\FPR_TPR_Threshold_Reviewer_Behavioral.xlsx'		# File for Writing FPR and TPR values at different thresholds for ROC curve analysis
		filename1 = 'Data\\Results\\YelpNYC\\Reviewer Behavioral\\'+cls[i]+'\\Pre_Recall_Threshold_Reviewer_Behavioral.xlsx'	# File for Writing Precision and Recall values at different thresholds for Precision-recall curve analysis
		f = 'Data\\Results\\YelpNYC\\Reviewer Behavioral\\'+cls[i]+'\\X_bal_sets.sav'
		...
		k = 1
		for mm in result:
			filename2 = 'Data\\Results\\YelpNYC\\Reviewer Behavioral\\'+cls[i]+'\\Model_'+str(k)+'.sav'			# Change the path according to the file location
