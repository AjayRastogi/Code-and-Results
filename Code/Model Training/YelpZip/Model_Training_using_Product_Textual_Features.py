...
if __name__ == "__main__":
	...
	cls = ["SVM", "LR", "MLP"]			
	X = pd.read_excel('Data\\YelpZip\\Resulting Features\\Product_Centric_Textual_Features.xlsx', sheetname=0)		# Change the path according to the file location
	...
	for i in range(0,3):
		...
		filename = 'Data\\Results\\YelpZip\\Product Textual\\'+cls[i]+'\\FPR_TPR_Threshold_Product_Textual.xlsx'		# File for Writing FPR and TPR values at different thresholds for ROC curve analysis
		filename1 = 'Data\\Results\\YelpZip\\Product Textual\\'+cls[i]+'\\Pre_Recall_Threshold_Product_Textual.xlsx'	# File for Writing Precision and Recall values at different thresholds for Precision-recall curve analysis
		f = 'Data\\Results\\YelpZip\\Product Textual\\'+cls[i]+'\\X_bal_sets.sav'
		...
		k = 1
		for mm in result:
			filename2 = 'Data\\Results\\YelpZip\\Product Textual\\'+cls[i]+'\\Model_'+str(k)+'.sav'			# Change the path according to the file location
